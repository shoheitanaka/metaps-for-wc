		...
		public function admin_footer_text( $footer_text ) {
			...
			if ( isset( $current_screen->id ) && $current_screen->id == $metaps_for_wc_pages ) {
				if ( ! get_option( 'metaps_for_wc_footer_text_rated' ) ) {
					$footer_text = sprintf( __( 'If you like <strong>metaps PAYMENT for WooCommerce.</strong> please leave us a %1$s&#9733;&#9733;&#9733;&#9733;&#9733;%2$s rating. A huge thanks in advance!', 'woo-paydesign' ), '<a href="https://wordpress.org/support/plugin/woocommerce-for-japan/reviews/#postform" target="_blank" class="wc4jp-rating-link" data-rated="' . esc_attr__( 'Thanks :)', 'woocommerce-for-japan' ) . '">', '</a>' );
					wc_enqueue_js(
						"
